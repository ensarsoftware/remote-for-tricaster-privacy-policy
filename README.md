...
The App offers optional in-app purchases (for example, unlocking “Pro” features). These purchases are processed entirely by Google Play Billing.
    ...
    Google’s handling of your purchase data is governed by the Google Play Terms of Service and Google Privacy Policy.
...
>>>>>>> 818d6c52c57b1bf38bcf8303443fdddbaef9492c
...
Uygulama, isteğe bağlı uygulama içi satın almalar sunar (örneğin “Pro” özelliklerinin kilidini açma). Bu satın almalar tamamen Google Play Faturalandırma (Google Play Billing) tarafından işlenir.
    ...
    Google’ın satın alma verilerinizi işlemesi, Google Play Hizmet Şartları ve Google Gizlilik Politikası ile yönetilir.
...
E-Soft / EnsarSoft
E-posta: ensarsoftware@gmail.com
