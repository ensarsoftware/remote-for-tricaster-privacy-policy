...
[Türkçe için aşağı kaydırın ↓](#tr)

This Privacy Policy describes how the mobile application **Remote for TriCaster** (package name `com.remote.tc`, the “App”), developed by **E-Soft / EnsarSoft** (the “Developer”, “we”, “us”), handles information. By installing or using the App you agree to this Privacy Policy.
...
You can erase all of this information at any time by clearing the App’s storage in Android Settings or by uninstalling the App.
...
The App offers optional in-app purchases (for example, unlocking “Pro” features). These purchases are processed entirely by **Google Play Billing**.

*   We do **not** receive or store your payment details (such as card numbers). Payment is handled by Google.
*   The App only learns whether a purchase was completed, so it can unlock the corresponding features on your device.
*   Google’s handling of your purchase data is governed by the [Google Play Terms of Service](https://play.google.com/intl/en/about/play-terms/) and [Google Privacy Policy](https://policies.google.com/privacy).

5\. Third-party services
------------------------

The only third-party service integrated into the App is **Google Play Billing** (described above), which is required to offer in-app purchases. The App does **not** include any analytics, advertising, crash-reporting, or tracking SDKs.

6\. Data sharing and selling
----------------------------

We do **not** sell, rent, or share your personal data with anyone. Because we do not collect your data on any server, there is nothing for us to share.

7\. Data retention and deletion
-------------------------------

All data the App uses is stored on your own device. We do not retain any copy. To delete it: clear the App’s data/storage from **Android Settings → Apps → Remote for TriCaster → Storage**, or uninstall the App.

8\. Children’s privacy
----------------------

The App is a professional broadcast/production tool and is not directed to children under 13. We do not knowingly collect personal information from children.
...
We may update this Privacy Policy from time to time. The “Last updated” date at the top of this page will reflect the latest revision. Significant changes will be communicated through the app store listing or within the App.

11\. Contact
------------

**E-Soft / EnsarSoft**  
Email: [ensarsoftware@gmail.com](mailto:ensarsoftware@gmail.com)

* * *

Gizlilik Politikası — Remote for TriCaster
==========================================

Son güncelleme: 21 Haziran 2026

Bu Gizlilik Politikası, **E-Soft / EnsarSoft** (“Geliştirici”, “biz”) tarafından geliştirilen **Remote for TriCaster** (paket adı `com.remote.tc`, “Uygulama”) adlı mobil uygulamanın bilgileri nasıl ele aldığını açıklar. Uygulamayı yükleyerek veya kullanarak bu Gizlilik Politikasını kabul etmiş olursunuz.
...
Bu bilgilerin tamamını, Android Ayarlar’dan Uygulama depolamasını temizleyerek veya Uygulamayı kaldırarak istediğiniz zaman silebilirsiniz.
...
4\. Satın almalar (Google Play Faturalandırma)
----------------------------------------------

Uygulama, isteğe bağlı uygulama içi satın almalar sunar (örneğin “Pro” özelliklerinin kilidini açma). Bu satın almalar tamamen **Google Play Faturalandırma (Google Play Billing)** tarafından işlenir.

*   Ödeme bilgilerinizi (kart numaraları gibi) almayız veya saklamayız. Ödeme Google tarafından gerçekleştirilir.
*   Uygulama yalnızca bir satın almanın tamamlanıp tamamlanmadığını öğrenir; böylece ilgili özelliklerin kilidini cihazınızda açabilir.
*   Google’ın satın alma verilerinizi işlemesi, [Google Play Hizmet Şartları](https://play.google.com/intl/tr/about/play-terms/) ve [Google Gizlilik Politikası](https://policies.google.com/privacy) ile yönetilir.

5\. Üçüncü taraf servisler
--------------------------

Uygulamaya entegre edilen tek üçüncü taraf servis, uygulama içi satın almaları sunmak için gereken **Google Play Faturalandırma**’dır (yukarıda açıklanmıştır). Uygulama; hiçbir analiz, reklam, çökme raporlama veya takip (tracking) SDK’sı içermez.

6\. Veri paylaşımı ve satışı
----------------------------

Kişisel verilerinizi hiç kimseye satmaz, kiralamaz veya paylaşmayız. Verilerinizi herhangi bir sunucuda toplamadığımız için paylaşılacak bir şey de yoktur.

7\. Veri saklama ve silme
-------------------------

Uygulamanın kullandığı tüm veriler kendi cihazınızda saklanır. Bizde herhangi bir kopyası tutulmaz. Silmek için: **Android Ayarlar → Uygulamalar → Remote for TriCaster → Depolama**’dan Uygulama verilerini temizleyin veya Uygulamayı kaldırın.

8\. Çocukların gizliliği
------------------------

Uygulama profesyonel bir yayın/prodüksiyon aracıdır ve 13 yaşın altındaki çocuklara yönelik değildir. Çocuklardan bilerek kişisel bilgi toplamayız.
...
Bu Gizlilik Politikasını zaman zaman güncelleyebiliriz. Sayfanın başındaki “Son güncelleme” tarihi en son revizyonu yansıtır. Önemli değişiklikler uygulama mağazası listesinde veya Uygulama içinde bildirilecektir.

11\. İletişim
-------------

**E-Soft / EnsarSoft**  
E-posta: [ensarsoftware@gmail.com](mailto:ensarsoftware@gmail.com)